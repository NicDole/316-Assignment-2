...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.8\textwidth]{experiment_3_2.png}
...
To evaluate the efficiency of our implementation, we generated square random matrices of sizes $2^5$ through $2^{10}$ (32 to 1024) and measured the runtime of both algorithms over 10 trials per size. We calculated the mean and variance for each method and plotted the results with error bars corresponding to approximately 97\% confidence intervals (twice the standard deviation).\\
\\
IMAGE (runtime plot: naïve 2D DFT vs. FFT with error bars)\\
\\
...
\end{itemize}
For the largest size tested ($N=1024$), the FFT was multiple orders of magnitude faster than the naïve method, aligning with the theoretical analysis presented earlier in the report.
